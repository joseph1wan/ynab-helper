...
To register a new Source (e.g. Amazon), add one import + one entry to
SCOPE_GETTERS below. Nothing in other_review.py needs to change.
"""
...
SCOPE_GETTERS = [target_scope, costco_scope, paypal_scope]
